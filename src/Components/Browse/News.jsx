...
const News = () => {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      await fetch(
        "https://newsapi.org/v2/top-headlines?country=in&category=business&domains=react-capstone-project-gold.vercel.app&apiKey=572f4d2dc96e42519d4c8861c0534d88"
      )
